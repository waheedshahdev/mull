        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <!-- end search -->
              ...
              <a href="<?php echo base_url('fines/add_fines');?>" style="float: right;" class="btn btn-info sbold green" >Add Fine</a>
           
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="fines_table" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>ID</th>
                  <th>Captain Name</th>
