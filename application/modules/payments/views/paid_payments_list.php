        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-header">
              ...
              <div class="col-md-1">
                <button type="button" class="btn btn-danger">Pay Payment</button>
              </div>
            </div>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="paid_payments_list" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>ID</th>
                  <th>Invoice ID</th>
...
//$('.myselects').on('change',function(){
  ...
  function check_status(){
    ...
    if(d!='' && s!=''){
     ...
     tbl_car.column(i).search(s).draw();

     tbl_car.column(j).search(d).draw();
   }
