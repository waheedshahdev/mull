<div class="container-fluid">
            <div class="row-fluid">   
                ...
                <div class="span12" id="content">
                    ...
                    <form action="" id="add_vendor_form"  class="form-horizontal" method="post">
						
                        <fieldset>
						<input type="hidden" name="office_area_id" id="office_area_id" value="<?php echo $this->session->userdata("id"); ?>"/>
                ...
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                           ...
                           <!--  <div class="control-group">
                            ...
                            <div class="form-actions">
                                <button type="submit" name="submit" onclick="add_vendor();" value="Add" class="btn btn-primary">Submit</button>
