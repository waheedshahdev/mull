    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <!-- Profile Image -->
          <?php $cat ="" ;foreach ($car_data as $car_profile) {
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Category</b> <a class="pull-right"><h4><?php if(empty($cat))
            {
              echo '<font color="red">Not Assign Yet</font>';
			...
			foreach($cat_ary as $cat_ids):
			
			 $result = $this->db->where("id",$cat_ids)->get("tbl_categories");
			 $results = $result->result_array();
			 //get_query_data("SELECT * FROM tbl_categories where tbl_categories.id = {$cat_ids}"  );
			 //print_r($results);
			...
			endforeach;
              ...
              <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#myModal">Change Car Category</button>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form role="form" action="<?php echo base_url();?>cars/car_info_update/<?php echo $this->uri->segment(3);?>" method="POST">
                        <div class="box-body">
                          ...
                          <div class="form-group">
                            <select class="form-control select2" style="width: 100%;" name="district_id" id="district_id">
                              ...
                              ?>
                              <option <?php if ($district->id == $district->id ) echo 'selected="selected"' ; ?> value="<?php echo $district->id;?>"><?php echo $district->district_name;?></option>
                            <?php endforeach;?>
                            </select>
                          </div>
                          <div class="form-group">
                      ...
                      <form role="form">
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <select class="form-control select2" name="category_id[]"  multiple="multiple" style="width: 100%;" name="category_id" id="category_id">
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Change Car Category</h4>
                      </div>
                      <div class="modal-body">
                        <form action="<?php echo base_url();?>cars/change_car_category/<?php echo $this->uri->segment(3);?>" method="post">
                         <div class="form-group">
                            <select class="form-control select2" style="width: 100%;" id="category_id" name="category_id">
                              <option>Select...</option>
                              <?php foreach ($assign_category as $category):
                              ?>
