<div class="content-wrapper">
    ...
    <section class="content">
       <button class="btn btn-info" >Send Notification to Inspection Officer</button>
      <div class="row">
        <!-- Left col -->
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>cars/update_single_inspection" method="post">
              <div class="box-body">
